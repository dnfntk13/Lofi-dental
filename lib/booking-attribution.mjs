...
export function summarizeBookingAttribution(records, sinceDay) {
  ...
  for (const record of records) {
    ...
    const label = [source.source, source.medium, source.campaign].filter(Boolean).join(' / ') || source.referrerHost || 'Direct / unattributed';
