...
13. Click `3일치 스캔` or `일주일치 스캔` in the popup or Instagram tab panel to save all readable DM conversations in that date range, regardless of read/unread status.
