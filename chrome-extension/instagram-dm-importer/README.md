...
- Manual scan and auto-scan use the left DM list pane, click the latest 10 visible DM rows one by one, move the right conversation pane to the first visible messages, read downward, and save readable conversations.
