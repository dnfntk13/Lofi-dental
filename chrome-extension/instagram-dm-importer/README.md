...
8. Click `Read each DM & save` any time to scan the DM list manually.
...
- Manual scan opens visible DM threads one by one in your already logged-in Instagram tab and saves readable conversations.
